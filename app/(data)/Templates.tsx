export default  [
...

    {
        ...
        desc: 'Use this tool to rewrite existing Articles or Blog Posts which can bypass AI detectors and also make it plagiarism free.',
    ...
    },
    {
        ...
        aiPrompt: 'Add Emoji to outline text depends on the outline and rewrite it in rich text editor format',
        form: [
            {
    ...
    },
    {
        ...
        aiPrompt: 'Generate 3 Instagram posts depends on given keywords and give output in  in rich text editor format',
        form: [
            {
    ...
    },
    {
        ...
        aiPrompt: 'Generate 15 Instagram hashtags depends on given keywords and give output in  in rich text editor format',
        form: [
            {
    ...
    },
    {
        ...
        aiPrompt: 'Generate 5-10 Instagram ideas depending on a niche with the latest trend and give output in  rich text editor format',
        form: [
            {
    ...
    },
    {
        ...
        aiPrompt: 'Depends on user productName and description generate a small description for the product for e-commerce business give output  in rich text editor format  ',
        form: [
            {
                label: 'Product Name',
                field: 'input',
